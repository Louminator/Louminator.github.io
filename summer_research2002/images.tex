...
\makeatother
{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap60}%
\resizebox{1.15in}{!}{\includegraphics{dipole_schem2.eps}}%
\lthtmlfigureZ
...
$\textstyle \parbox{4in}{
\begin{center}
Summer 2002 Research Opportunity
\par Applied Mathematics
\par Vorticity Dynamics \& Modeling
\end{center}}$%
\lthtmlinlinemathZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap64}%
\resizebox{1.15in}{!}{\includegraphics{lamb109d0030.eps}}%
\lthtmlfigureZ
\hfill\lthtmlcheckvsize\clearpage}
...
$\textstyle \parbox{3in}{Prof. Louis F. Rossi \\
