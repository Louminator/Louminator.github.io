...
\providecommand{\eqn}[1]{equation (\ref{#1})} 
\providecommand{\eqnn}[1]{(\ref{#1})}
\providecommand{\BF}{BlobFlow{\tiny$^{\rm TM}$ }\ }
...
\title{\begin{center}
\ \epsfysize=2.5in \epsfbox{figs/BlobFlow_logo_short.eps}\ 
\end{center}
 A high order vortex method for viscous flows \\
User's Guide \\Version $1.0$\space for BlobFlow v2.01.}
...
$\displaystyle \omega(\v x,t) = \sum_{i=1}^N g(\v x;\gamma_i,\v x_i,\sigma_i,a_i,\theta_i)$%
\lthtmlinlinemathZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay1006}%
$\displaystyle g(\v x;\gamma_i,\v x_i,\sigma_i,a_i,\theta_i) = \hfill$%
\lthtmlinlinemathZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay1007}%
$\displaystyle {\gamma_i \over 4 \pi \sigma_i^2}
\exp\left\{
...
\begin{displaymath}\frac{x^2}{a^2} + y^2a^2 > C_R \sigma^2
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
