...
\stepcounter{section}
{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap59}%
\resizebox{!}{1.5in}{\includegraphics{parabola.eps}}%
\lthtmlfigureZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap61}%
\resizebox{1.5in}{!}{\includegraphics{incidence.eps}}%
\lthtmlfigureZ
\hfill\lthtmlcheckvsize\clearpage}
