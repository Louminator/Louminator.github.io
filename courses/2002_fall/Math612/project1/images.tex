...
\begin{displaymath}u_t = (\kappa u_x)_x \ \ \ \ x \in [0,1]
\end{displaymath}%
\lthtmldisplayZ
...
{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap78}%
\resizebox{2in}{!}{\includegraphics{canal.eps}}%
\lthtmlfigureZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmldisplayA{displaymath32}%
\begin{displaymath}u(x,0) =
\begin{cases}
10^{-1}, & x \in [0, 0.3] \\
0, & \text{otherwise.}
\end{cases}
...
\begin{displaymath}u_t + U u_x = (\kappa u_x)_x \ \ \ \ x \in [0,1]
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
