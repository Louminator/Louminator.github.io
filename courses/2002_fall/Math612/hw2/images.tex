...
\begin{displaymath}v^{n+1}_j = v^n_j + \frac{\kappa k}{h^2} (v^n_{j+1} - 2v^n_j + v^n_{j-1})
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}u_t = \kappa u_{xx}.
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}v^{n+1}_j = v^n_j + \frac{\kappa k}{h^2} (v^{n+1}_{j+1} - 2v^{n+1}_j + 
v^{n+1}_{j-1})
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}v^{n+1}_j = v^{n-1}_j + \frac{2\kappa k}{h^2} (v^{n}_{j+1} - 2v^{n}_j + 
v^{n}_{j-1})
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}v^{n+1}_j = v^{n}_j + \frac{2\kappa k}{h^2} 
\left[
\theta (v^{n}_{j+1} - 2v^{n}_j + v^{n}_{j-1}) +
(1-\theta) (v^{n+1}_{j+1} - 2v^{n+1}_j + v^{n+1}_{j-1})
\right]
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}|\langle v,w\rangle| \leq \|v\| \|w\|.
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
