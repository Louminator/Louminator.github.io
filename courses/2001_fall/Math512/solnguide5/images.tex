...
$\textstyle \parbox{3in}{\begin{tabular}{|l|l|}
\hline Time (min) & CO (ppm) \\\hline \hline
0 & 0.7 \\\hline
10 & 5.0 \\\hline
20 & 10.3 \\\hline
30 & 14.0 \\\hline
...
{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap146}%
\resizebox{2.5in}{2in}{\includegraphics{fitcurve.eps}}%
\lthtmlfigureZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap148}%
\resizebox{2.5in}{2in}{\includegraphics{fitcurve2.eps}}%
\lthtmlfigureZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}q_1(x,t) = \frac{C}{\sqrt{4 \pi \nu t}} 
e^{\left(-\frac{(x-Ut)^2}{4 \nu t}\right)}.
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}q(x,t) = \int_0^t q_1(x,\tau) d\tau
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}q(x,t) =
\frac{C}{2 U} e^{\left(\frac{Ux}{2\nu}\right)}
\left[
{\rm erfc}\left(\frac{x+Ut}{2 \sqrt{4 \nu t}}\right)
e^{\left(\frac{Ux}{2\nu}\right)}
-
{\rm erfc}\left(\frac{x-Ut}{2 \sqrt{4 \nu t}}\right)
e^{\left(-\frac{Ux}{2\nu}\right)}
