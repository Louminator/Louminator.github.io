...
\parbox{1.5in}{\resizebox{1in}{0.75in}{\includegraphics{#1}}}\ 
\parbox{1.5in}{\resizebox{1in}{0.75in}{\includegraphics{#2}}}
\end{center}}

\providecommand{\OneFigure}[1]{\begin{center}
\resizebox{3in}{!}{\includegraphics{#1}}\end{center}}
...
\begin{displaymath}\{1,e^{-x},e^{-2x},...,e^{-nx}\}.
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
