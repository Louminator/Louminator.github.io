...
\stepcounter{section}
{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap110}%
...
\begin{displaymath}\iint_S \v E \cdot \widehat{n} dA = \frac{Q}{\epsilon}
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}\sigma(r,t) = 
1+
\frac{1}{r}
\sin\left[\frac{2\pi (r-8)}{42}\right] 
\sin\left(\frac{2 \pi t}{100}\right)
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}\epsilon' = 1+\sigma(\epsilon-1).
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
