...
\makeatother
{\newpage\clearpage
\lthtmlfigureA{tex2html_wrap77}%
\resizebox{4in}{!}{\includegraphics{quizpic.eps}}%
\lthtmlfigureZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmldisplayA{displaymath21}%
\begin{displaymath}V = \int_0^1\int_{x}^{2-x} (y^2+2) dy dx
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}V = \int_0^1\int_0^{y} (y^2+2) dx dy+
\int_1^2\int_{0}^{2-y} (y^2+2) dx dy.
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
