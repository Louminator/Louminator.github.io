...
\providecommand{\proj}[1]{{\rm proj}_{#1}}
\providecommand{\comp}[1]{{\rm comp}_{#1}}
...
\begin{eqnarray*}{\v r_1} (t) & = & \langle \cos(2t) , \sin(2t) , \cos(3t) \rangle, \\
{\v r_2} (t) & = & \langle \cos(2t) , \sin(2t) , \cos(\pi t) \rangle.
\end{eqnarray*}%
\lthtmldisplayZ
...
\begin{displaymath}{\v r} (t) = \langle \cos(t) , \sin(t) , t \rangle,
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}\frac{1}{4}x^2 + y^2 + z^2 - 5x -10 y + 16 z + 113 = 0.
\end{displaymath}%
\lthtmldisplayZ
\hfill\lthtmlcheckvsize\clearpage}
